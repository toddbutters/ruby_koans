...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the former visually but not sure which in practice.
  # I asked Perplexity.ai to summarize for when to use either though:
  # - Use `class << self` when:
  #   1. Defining multiple class methods together
  #   2. Working on larger, more complex classes
  #   3. You want to clearly separate class and instance methods
  #
  # - Use `def self.method` when:
  #   1. Adding a single class method
  #   2. Working on smaller, simpler classes
  #   3. You need to quickly prototype or add functionality
